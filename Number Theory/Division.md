...
- **Recursive GCD/LCM**: we can verify directly from definition that $$(a_1,\cdots,a_n)=(a_1,(a_2,\cdots))\quad\text{and}\quad[a_1,\cdots,a_n]=[a_1,[a_2,\cdots]]$$this is useful when dealing with GCD/LCM of multiple numbers. 
